...
func New(
	...
	*/
	...
	app.ExampleKeeper = *examplemodulekeeper.NewKeeper(
		appCodec,
		keys[examplemoduletypes.StoreKey],
		keys[examplemoduletypes.MemStoreKey],
		app.GetSubspace(examplemoduletypes.ModuleName),
	)
